...
function kdeQuery(nameType, mapType) {
	...
	if(nameType == "surname"){
		...
		width = document.getElementById("surnamemap").clientWidth;
		height = document.getElementById("surnamemap").clientHeight;
		...
		width = document.getElementById("forenamemap").clientWidth;
		height = document.getElementById("forenamemap").clientHeight;
...
function kdeQueryImp(configuredData, nameType, mapType) {
	...
	if(nameType == "surname"){
		...
		scriptLocation = state.serviceBase + "services/queryForename?callback=?";
